...
if {$QSFP_SPEED == "10G"} {
	...
	set_property -dict [list CONFIG.LINE_RATE {25} CONFIG.INCLUDE_AXI4_INTERFACE {1} CONFIG.GT_DRP_CLK {200} CONFIG.ENABLE_TX_FLOW_CONTROL_LOGIC {0} CONFIG.ENABLE_RX_FLOW_CONTROL_LOGIC {0}] [get_bd_cells QSFP/QSFP_${QSFP_INDEX}/eth]
} else {
