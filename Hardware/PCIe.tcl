...
set_property -dict [list CONFIG.CLK_IN1_BOARD_INTERFACE $PCIe_CLOCK CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_USED {false} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {266.66667} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ $USER_CLOCK CONFIG.USE_LOCKED {false} CONFIG.PRIM_SOURCE {Differential_clock_capable_pin} CONFIG.NUM_OUT_CLKS {2}] [get_bd_cells PCIe/clk_wiz_0]
...
connect_bd_net [get_bd_pins PCIe/XDMA/axi_aclk] [get_bd_pins PCIe/XDMA_interconnect/ACLK]
...
connect_bd_net [get_bd_pins PCIe/config_clk] [get_bd_pins PCIe/XDMA/axi_aclk]
connect_bd_net [get_bd_pins PCIe/XDMA_interconnect/M00_ACLK] [get_bd_pins PCIe/XDMA/axi_aclk]
connect_bd_net [get_bd_pins PCIe/XDMA_interconnect/M01_ACLK] [get_bd_pins PCIe/XDMA/axi_aclk]
connect_bd_net [get_bd_pins PCIe/XDMA_interconnect/M02_ACLK] [get_bd_pins PCIe/XDMA/axi_aclk]
connect_bd_net [get_bd_pins PCIe/XDMA_interconnect/M03_ACLK] [get_bd_pins PCIe/XDMA/axi_aclk]
...
connect_bd_net [get_bd_pins PCIe/clk_wiz_0/clk_in1_n] [get_bd_pins PCIe/util_ds_buf_0/IBUF_DS_N]
connect_bd_net [get_bd_pins PCIe/clk_wiz_0/clk_in1_p] [get_bd_pins PCIe/util_ds_buf_0/IBUF_DS_P]
