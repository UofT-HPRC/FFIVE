...
for {set DDR4_INDEX 0} {$DDR4_INDEX < $DDR4_COUNT} {incr DDR4_INDEX} {
	...
	create_bd_pin -dir O DDR4/clk_ddr_$DDR4_INDEX
	create_bd_pin -dir O DDR4/resetn_ddr_$DDR4_INDEX
	create_bd_pin -dir O DDR4/resetp_ddr_$DDR4_INDEX
}
...
create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 DDR4/ddr4_reset_hub
for {set DDR4_INDEX 0} {$DDR4_INDEX < $DDR4_COUNT} {incr DDR4_INDEX} {
...
connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/ddr4_reset_hub/slowest_sync_clk]
connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/axi_interconnect/ACLK]
connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/axi_interconnect/S00_ACLK]
connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/axi_interconnect/S01_ACLK]
for {set DDR4_INDEX 0} {$DDR4_INDEX < $DDR4_COUNT} {incr DDR4_INDEX} {
	set DDR4_INTERFACE [lindex $DDR4_INTERFACES $DDR4_INDEX]
	connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/clk_ddr_$DDR4_INDEX]
	connect_bd_net [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_ui_clk] [get_bd_pins DDR4/axi_interconnect/M0${DDR4_INDEX}_ACLK]
	connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/$DDR4_INTERFACE/c0_ddr4_aresetn]
	connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/axi_interconnect/M0${DDR4_INDEX}_ARESETN]
	connect_bd_net [get_bd_pins DDR4/polarity_flipper/Res] [get_bd_pins DDR4/$DDR4_INTERFACE/sys_rst]
	connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/resetn_ddr_$DDR4_INDEX]
	connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/peripheral_reset] [get_bd_pins DDR4/resetp_ddr_$DDR4_INDEX]
}
connect_bd_net [get_bd_pins DDR4/global_reset] [get_bd_pins DDR4/ddr4_reset_hub/ext_reset_in]
connect_bd_net [get_bd_pins DDR4/global_reset] [get_bd_pins DDR4/polarity_flipper/Op1]
connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/axi_interconnect/ARESETN]
connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/axi_interconnect/S00_ARESETN]
connect_bd_net [get_bd_pins DDR4/ddr4_reset_hub/interconnect_aresetn] [get_bd_pins DDR4/axi_interconnect/S01_ARESETN]
