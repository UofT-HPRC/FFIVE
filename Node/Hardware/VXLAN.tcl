...
for {set QSFP_INDEX 0} {$QSFP_INDEX < $QSFP_COUNT} {incr QSFP_INDEX} {
    ...
    for {set VXLAN_INDEX 0} {$VXLAN_INDEX < $VXLAN_COUNT} {incr VXLAN_INDEX} {
        ...
        set GPIO_INDEX1 [format %03s $GPIO_INDEX1]
        set GPIO_INDEX2 [format %03s $GPIO_INDEX2]
        set GPIO_INDEX3 [format %03s $GPIO_INDEX3]
        set GPIO_INDEX4 [format %03s $GPIO_INDEX4]
        connect_bd_net [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/GPIO_net/GPIO_${GPIO_INDEX1}_OUT] [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/VXLAN_${VXLAN_INDEX}/ip_addr_V]
        connect_bd_net [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/GPIO_net/GPIO_${GPIO_INDEX2}_OUT] [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/VXLAN_${VXLAN_INDEX}/local_port_V]
        connect_bd_net [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/GPIO_net/GPIO_${GPIO_INDEX3}_OUT] [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/VXLAN_${VXLAN_INDEX}/remote_port_V]
        connect_bd_net [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/GPIO_net/GPIO_${GPIO_INDEX4}_OUT] [get_bd_pins VXLAN/VXLAN_${QSFP_INDEX}/VXLAN_${VXLAN_INDEX}/vni_V]
